...
namespace BankingApp.API.Migrations
{
    ...
    [Migration("20200505105558_ChangedLoans")]
    partial class ChangedLoans
    {
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 5, 13, 55, 57, 650, DateTimeKind.Local).AddTicks(6738));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("DateIssued")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 5, 13, 55, 57, 697, DateTimeKind.Local).AddTicks(8614));
