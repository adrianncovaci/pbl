...
namespace BankingApp.API.Migrations
{
    ...
    [Migration("20200520164353_DateTimeToCreditScoreHistory")]
    partial class DateTimeToCreditScoreHistory
    {
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.BankAccount", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 20, 19, 43, 53, 279, DateTimeKind.Local).AddTicks(2056));
            ...
            modelBuilder.Entity("BankingApp.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("DateIssued")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 20, 19, 43, 53, 322, DateTimeKind.Local).AddTicks(2857));
